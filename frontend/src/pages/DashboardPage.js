...
//           <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-4xl h-[90vh] overflow-y-auto relative">
...
//             {/* FileBrowser will handle uploads/creations within the popup */}
...
//         <Header
//   allItems={[...files, ...folders]} // Combine both
//   onSearchResults={(results) => setFilteredData(results)} // Update your display
// />
